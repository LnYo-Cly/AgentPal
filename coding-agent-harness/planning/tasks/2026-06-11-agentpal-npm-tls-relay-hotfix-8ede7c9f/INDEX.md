# AgentPal npm TLS relay hotfix - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-11-agentpal-npm-tls-relay-hotfix-8ede7c9f` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal npm TLS relay hotfix' . |
| Budget | standard |
