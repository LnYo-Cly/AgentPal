# AgentPal project explorer expand and file preview - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-06-agentpal-project-explorer-expand-and-file-previe-393118ff` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal project explorer expand and file preview' . |
| Budget | standard |
