# AgentPal Host pairing MVP - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-01-agentpal-host-pairing` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task 2026-06-01-agentpal-host-pairing --budget standard --locale zh-CN --title 'AgentPal Host pairing MVP' . |
| Budget | standard |
