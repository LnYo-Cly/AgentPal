# Harness task lifecycle repair - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-07-harness-task-lifecycle-repair-20962c77` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'Harness task lifecycle repair' . |
| Budget | standard |
