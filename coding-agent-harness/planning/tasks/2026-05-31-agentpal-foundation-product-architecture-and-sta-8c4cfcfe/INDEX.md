# AgentPal foundation product architecture and stack SSoT - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-05-31-agentpal-foundation-product-architecture-and-sta-8c4cfcfe` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal foundation product architecture and stack SSoT' . |
| Budget | standard |
...
| Confirmation ID | HRC-202605310758 |
| Confirmed At | 2026-05-31 07:58 |
