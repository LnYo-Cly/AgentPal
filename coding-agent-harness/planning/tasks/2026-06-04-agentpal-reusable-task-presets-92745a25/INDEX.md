# AgentPal reusable task presets - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-04-agentpal-reusable-task-presets-92745a25` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal reusable task presets' . |
| Budget | standard |
