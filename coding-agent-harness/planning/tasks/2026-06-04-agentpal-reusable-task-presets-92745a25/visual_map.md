...
| GATE-01 | gate | EXEC-02 | blocked | 0 | Agent Review Submission material ready but lifecycle command blocked by dirty write-scope | `review.md`、progress update、lesson routing | `harness task-review 2026-06-04-agentpal-reusable-task-presets-92745a25 --message "AgentPal reusable task presets ready"` | agent | partial | CLI refused: governance sync owned path in write scope is already dirty | coordinator |
