# AgentPal mobile APK IPA build - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-11-agentpal-mobile-apk-ipa-build-d584f8ae` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile APK IPA build' . |
| Budget | standard |
