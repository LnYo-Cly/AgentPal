# OpenAgentPal CLI cloud relay MVP - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-07-openagentpal-cli-cloud-relay-mvp-455f888e` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'OpenAgentPal CLI cloud relay MVP' . |
| Budget | complex |
