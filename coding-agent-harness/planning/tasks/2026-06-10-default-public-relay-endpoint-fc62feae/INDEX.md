# Default public relay endpoint - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-default-public-relay-endpoint-fc62feae` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'Default public relay endpoint' . |
| Budget | simple |
