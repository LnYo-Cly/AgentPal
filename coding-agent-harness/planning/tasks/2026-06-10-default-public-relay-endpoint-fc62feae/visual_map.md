...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| INIT-01 | init | none | planned | 0 | 任务边界已清楚到可以执行 | `task_plan.md` | `harness task-start 2026-06-10-default-public-relay-endpoint-fc62feae` | agent | missing | none | coordinator |
