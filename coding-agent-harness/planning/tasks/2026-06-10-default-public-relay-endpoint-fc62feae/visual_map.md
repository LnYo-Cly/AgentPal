...
| EXEC-01 | execution | INIT-01 | done | 100 | 默认公网 Relay 已切到 Railway 域名 | diff、cargo/mobile checks、CLI help、live healthcheck、harness check | `harness task-phase 2026-06-10-default-public-relay-endpoint-fc62feae EXEC-01 --state done --completion 100 --evidence present` | agent | present | branded domain/VPS remains follow-up | coordinator |
| GATE-01 | gate | EXEC-01 | done | 100 | 直接完成任务 | progress update 和最终证据说明 | `harness task-complete 2026-06-10-default-public-relay-endpoint-fc62feae --message "<summary>"` | agent | present | real phone scan remains user-operated | coordinator |
