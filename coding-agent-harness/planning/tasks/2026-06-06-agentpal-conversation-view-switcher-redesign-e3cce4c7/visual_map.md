...
| EXEC-01 | execution | INIT-01 | done | 100 | 有边界的实现、文档切片和验证证据 | diff、commands、worker handoff 或 artifact path | `harness task-phase 2026-06-06-agentpal-conversation-view-switcher-redesign-e3cce4c7 EXEC-01 --state done --completion 100 --evidence present` | agent | present | [risk] | [owner] |
