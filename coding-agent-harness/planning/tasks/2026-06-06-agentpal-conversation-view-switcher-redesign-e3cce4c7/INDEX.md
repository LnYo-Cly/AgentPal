# AgentPal conversation view switcher redesign - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-06-agentpal-conversation-view-switcher-redesign-e3cce4c7` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal conversation view switcher redesign' . |
| Budget | standard |
