# AgentPal mobile workbench UI repair - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-01-agentpal-mobile-workbench-ui-repair-5316c918` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile workbench UI repair' . |
| Budget | standard |
