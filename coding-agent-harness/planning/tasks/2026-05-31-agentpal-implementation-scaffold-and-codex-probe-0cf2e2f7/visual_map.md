...
| EXEC-01 | execution | INIT-01 | done | 100 | AgentPal scaffold、Relay、Host Codex probe、移动端首屏 | diff、commands、probe report | `harness task-phase 2026-05-31-agentpal-implementation-scaffold-and-codex-probe-0cf2e2f7 EXEC-01 --state done --completion 100 --evidence present` | agent | present | Codex app-server 入口可能返回 non-101 | coordinator |
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission | `review.md`、progress update、lesson routing | `harness task-review 2026-05-31-agentpal-implementation-scaffold-and-codex-probe-0cf2e2f7 --message "<summary>"` | agent | present | waits for validation | coordinator |
