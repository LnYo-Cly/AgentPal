...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| INIT-01 | init | none | planned | 0 | 任务计划和执行策略已确认 | `task_plan.md`; `execution_strategy.md` | `harness task-start 2026-05-31-agentpal-implementation-scaffold-and-codex-probe-0cf2e2f7` | agent | missing | none | coordinator |
