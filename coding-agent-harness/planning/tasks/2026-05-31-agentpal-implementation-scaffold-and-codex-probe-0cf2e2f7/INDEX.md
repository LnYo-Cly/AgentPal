# AgentPal implementation scaffold and Codex probe - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-05-31-agentpal-implementation-scaffold-and-codex-probe-0cf2e2f7` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal implementation scaffold and Codex probe' . |
| Budget | standard |
...
| Confirmation ID | HRC-202605311058 |
| Confirmed At | 2026-05-31 10:58 |
