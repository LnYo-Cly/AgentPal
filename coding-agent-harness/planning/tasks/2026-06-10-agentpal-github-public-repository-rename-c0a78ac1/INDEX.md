# AgentPal GitHub public repository rename - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-agentpal-github-public-repository-rename-c0a78ac1` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal GitHub public repository rename' . |
| Budget | standard |
