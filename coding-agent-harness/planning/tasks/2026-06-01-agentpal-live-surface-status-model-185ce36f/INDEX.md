# AgentPal live surface status model - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-01-agentpal-live-surface-status-model-185ce36f` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal live surface status model' . |
| Budget | standard |
