# AgentPal conversation workbench state and layout repair - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-05-agentpal-conversation-workbench-state-and-layout-d31a183a` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal conversation workbench state and layout repair' . |
| Budget | standard |
