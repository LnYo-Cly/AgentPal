# AgentPal mobile sessions and conversation layout correction - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-06-agentpal-mobile-sessions-and-conversation-layout-5c9c8fe4` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile sessions and conversation layout correction' . |
| Budget | standard |
