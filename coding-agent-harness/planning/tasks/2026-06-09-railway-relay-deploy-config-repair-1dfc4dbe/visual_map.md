...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| INIT-01 | init | none | planned | 0 | 任务边界已清楚到可以执行 | `task_plan.md` | `harness task-start 2026-06-09-railway-relay-deploy-config-repair-1dfc4dbe` | agent | missing | none | coordinator |
