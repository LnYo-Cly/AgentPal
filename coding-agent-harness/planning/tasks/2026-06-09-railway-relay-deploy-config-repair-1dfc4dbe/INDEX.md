# Railway Relay deploy config repair - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-09-railway-relay-deploy-config-repair-1dfc4dbe` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'Railway Relay deploy config repair' . |
| Budget | simple |
