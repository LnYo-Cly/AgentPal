# AgentPal mobile session IA follow-up polish - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-07-agentpal-mobile-session-ia-follow-up-polish-0fef8c3e` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile session IA follow-up polish' . |
| Budget | standard |
