# AgentPal mobile workbench and sessions IA correction - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-06-agentpal-mobile-workbench-and-sessions-ia-correc-a2978171` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile workbench and sessions IA correction' . |
| Budget | standard |
