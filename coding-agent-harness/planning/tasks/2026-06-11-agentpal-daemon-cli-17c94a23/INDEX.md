...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-11-agentpal-daemon-cli-17c94a23` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal daemon 常驻 CLI' . |
| Budget | standard |
