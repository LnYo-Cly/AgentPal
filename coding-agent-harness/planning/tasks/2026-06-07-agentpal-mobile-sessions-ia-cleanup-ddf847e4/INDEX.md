# AgentPal mobile sessions IA cleanup - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-07-agentpal-mobile-sessions-ia-cleanup-ddf847e4` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile sessions IA cleanup' . |
| Budget | standard |
