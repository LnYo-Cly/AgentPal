...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission materials ready | `review.md`、progress update、lesson routing | `harness task-review 2026-06-07-agentpal-mobile-sessions-ia-cleanup-ddf847e4 --message "<summary>"` | agent | present | must not claim human confirmation | coordinator |
