# AgentPal mobile three-tab conversation redesign - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-01-agentpal-mobile-three-tab-conversation-redesign-e4e15f3e` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile three-tab conversation redesign' . |
| Budget | standard |
