# AgentPal CLI update notice - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-agentpal-cli-update-notice-403bf715` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal CLI update notice' . |
| Budget | standard |
