# AgentPal local end-to-end mobile host relay loop - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-05-31-agentpal-local-end-to-end-mobile-host-relay-loop-c90f483a` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal local end-to-end mobile host relay loop' . |
| Budget | standard |
...
| Confirmation ID | HRC-202605311132 |
| Confirmed At | 2026-05-31 11:32 |
