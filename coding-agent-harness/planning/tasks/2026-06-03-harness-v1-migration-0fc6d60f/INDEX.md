# Harness v1 legacy migration - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-03-harness-v1-migration-0fc6d60f` |
| Budget | `complex` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --preset legacy-migration --from-session '<session.json>' '<target>' |
| Budget | complex |
...
| Confirmation ID | HRC-202606031420 |
| Confirmed At | 2026-06-03 14:20 |
