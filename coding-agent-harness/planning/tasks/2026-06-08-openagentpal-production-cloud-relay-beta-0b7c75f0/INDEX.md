# OpenAgentPal Production Cloud Relay Beta - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-08-openagentpal-production-cloud-relay-beta-0b7c75f0` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'OpenAgentPal Production Cloud Relay Beta' . |
| Budget | complex |
