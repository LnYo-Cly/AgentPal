# AgentPal mobile cold visual redesign - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-01-agentpal-mobile-cold-visual-redesign-b37239ca` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile cold visual redesign' . |
| Budget | standard |
