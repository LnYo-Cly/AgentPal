# AgentPal public command naming - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-agentpal-public-command-naming-41fcec16` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal public command naming' . |
| Budget | standard |
