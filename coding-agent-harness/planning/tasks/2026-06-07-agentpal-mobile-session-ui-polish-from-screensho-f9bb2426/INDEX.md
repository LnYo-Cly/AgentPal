# AgentPal mobile session UI polish from screenshots - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-07-agentpal-mobile-session-ui-polish-from-screensho-f9bb2426` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile session UI polish from screenshots' . |
| Budget | standard |
