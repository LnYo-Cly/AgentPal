# AgentPal npm public release - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-agentpal-npm-public-release-f0c0ca12` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal npm public release' . |
| Budget | standard |
