# AgentPal README product narrative refresh - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-10-agentpal-readme-product-narrative-refresh-6ac86ba0` |
| Budget | `simple` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget simple --locale zh-CN --title 'AgentPal README product narrative refresh' . |
| Budget | simple |
