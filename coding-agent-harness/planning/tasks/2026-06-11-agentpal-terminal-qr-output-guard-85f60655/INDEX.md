# AgentPal terminal QR output guard - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-11-agentpal-terminal-qr-output-guard-85f60655` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal terminal QR output guard' . |
| Budget | standard |
