# AgentPal session history and inbox UX redesign - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-05-agentpal-session-history-and-inbox-ux-redesign-af6730dc` |
| Budget | `complex` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget complex --locale zh-CN --title 'AgentPal session history and inbox UX redesign' . |
| Budget | complex |
