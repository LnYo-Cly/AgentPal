...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission | `review.md`、progress update、lesson routing | `harness task-review 2026-06-06-agentpal-mobile-workspace-session-browser-redesi-80719f34 --message "<summary>"` | agent | present | [risk] | coordinator |
