# AgentPal mobile workspace session browser redesign - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-06-agentpal-mobile-workspace-session-browser-redesi-80719f34` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal mobile workspace session browser redesign' . |
| Budget | standard |
