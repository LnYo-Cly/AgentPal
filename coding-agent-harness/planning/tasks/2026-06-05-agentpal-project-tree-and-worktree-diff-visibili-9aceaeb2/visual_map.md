...
| GATE-01 | gate | EXEC-02 | review | 100 | Agent Review Submission manually recorded and scanner-normalized | `review.md`、progress update、lifecycle repair note | `harness task-review 2026-06-05-agentpal-project-tree-and-worktree-diff-visibili-9aceaeb2 --message "<summary>"` | agent | present | none | coordinator |
