# AgentPal project tree and worktree diff visibility - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-06-05-agentpal-project-tree-and-worktree-diff-visibili-9aceaeb2` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal project tree and worktree diff visibility' . |
| Budget | standard |
