# AgentPal real Codex vertical slice - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-05-31-agentpal-real-codex-vertical-slice-95a01ac2` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `no` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title 'AgentPal real Codex vertical slice' . |
| Budget | standard |
...
| Confirmation ID | HRC-202605310946 |
| Confirmed At | 2026-05-31 09:46 |
| Reviewer | Human Reviewer |
| Reviewer Email | lnyocly@gmail.com |
| Confirm Text | 2026-05-31-agentpal-real-codex-vertical-slice-95a01ac2 |
| Evidence Checked | TARGET:coding-agent-harness/planning/tasks/2026-05-31-agentpal-real-codex-vertical-slice-95a01ac2/review.md |
| Review Commit SHA | 4ac0d0614b573930f16fc228c97c3eb24bac2569 |
