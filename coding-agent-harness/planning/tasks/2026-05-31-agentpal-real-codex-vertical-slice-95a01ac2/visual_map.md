...
| GATE-01 | gate | EXEC-01 | done | 100 | Agent Review Submission | `review.md`、progress update、lesson routing | `harness task-review 2026-05-31-agentpal-real-codex-vertical-slice-95a01ac2 --message "<summary>"` | agent | present | waits for final validation | coordinator |
